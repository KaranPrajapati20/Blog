  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      try {
        ...
        const filter = response.data.filter(post => post.likes > 1000);
        setPosts(filter);
            ...
            <div className="flex w-full p-4 border-b-[0.2px] border-b-[#2F3336] border-opacity-70  " key={post._id}>
              ...
              <div className="flex ml-4 flex-col  w-full   ">
                ...
                <div className="flex mt-4 mb-2  ">
                    ...
                    <div className="hover:opacity-70 flex cursor-pointer p-2 rounded-full bg-[#1D9BF0] gap-2 px-4 ml-2 justify-center items-center " onClick={() => handleLike(post._id)} >
                    <BiSolidLike /> <p>{formatNumber(post.likes)}</p>
                    </div>

                    <div className="flex cursor-pointer hover:opacity-70 p-2 rounded-full bg-[#1D9BF0] gap-2 px-4 ml-2 justify-center items-center " onClick={() => handleDislike(post._id)} >
