...
//           <div className="flex w-full p-4 border-b-[0.2px] border-b-[#2F3336] border-opacity-70  ">
//             <div>
//               <img
...
//                   <p className="text-[18px] font-semibold">karan</p>
//                   <p className="text-[16px] opacity-70 ">title</p>
...
//                 </div>
//               </div>
//               <img className=" rounded-md mt-4 ml-[20px] max-h-[400px] w-[80%] " src={userImage} alt="" />
//             </div>
            ...
            <div className="flex w-full p-4 border-b-[0.2px] border-b-[#2F3336] border-opacity-70  " key={post._id}>
              ...
              <div className="flex ml-4 flex-col  w-full   ">
                ...
                <div className="flex mt-4 mb-2  ">
                    ...
                    <div className="flex hover:opacity-70 cursor-pointer p-2 rounded-full bg-[#1D9BF0] gap-2 px-4 ml-2 justify-center items-center " onClick={() => handleLike(post._id)} >
                    <BiSolidLike /> <p>{formatNumber(post.likes)}</p>
                    </div>

                    <div className="flex hover:opacity-70 cursor-pointer p-2 rounded-full bg-[#1D9BF0] gap-2 px-4 ml-2 justify-center items-center " onClick={() => handleDislike(post._id)} >
...
{/* <button onClick={() => handleLike(post._id)} className="mr-2 p-2 bg-[#1D9BF0] rounded-full px-4 opacity-80 hover:opacity-50 ">
                  <BiSolidLike /> ({post.likes})  
                  </button>
                  <button onClick={() => handleDislike(post._id)} className="mr-mr-2 p-2 bg-[#1D9BF0] rounded-full px-4 opacity-80 hover:opacity-50" >
                  <BiSolidDislike /> ({post.dislikes})
                  </button> */}